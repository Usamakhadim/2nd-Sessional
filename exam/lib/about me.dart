        ...
        body: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('Muhammad usama', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
              SizedBox(height: 20,),
              Text('03076852887', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 30),),
              SizedBox(height: 20,),
              Text('usamakhadim055@gmail.com', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
            ],
          ),
        ),
